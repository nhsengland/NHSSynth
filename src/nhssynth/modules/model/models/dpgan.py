...
#             IntegerDistribution(name="generator_n_units_hidden", low=50, high=150, step=50),
...
#             IntegerDistribution(name="discriminator_n_units_hidden", low=50, high=150, step=50),
